module Moves (Turn(..), Algorithm(..), Face(..), Axis(..), algToPerm, possibleTurns, permOfTurn, applyMove, lengthAlg, axisOfFace, isCanonicalSecuence) where
...
applyMove :: Cube -> Turn -> Cube
applyMove c t = c <> (permOfTurn t)
